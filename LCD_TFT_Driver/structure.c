...
const struct Sensor slider =
               {
                  ...
                  .numElements = 5,
                  .baseOffset = 0,
                  .cbpdBits = (BIT0+BIT1+BIT2+BIT3+BIT4),
				  .points = 100,
				  .sensorThreshold = 75,
                  // Pointer to elements
                  ...
                  .cboutTAxDirRegister = (unsigned char *)&P3DIR,  // PxDIR
                  .cboutTAxSelRegister = (unsigned char *)&P3SEL,  // PxSEL
                  .cboutTAxBits = BIT0, // P1.0
                  // Timer Information
//                  .measGateSource= GATE_WDT_ACLK,     //  0->SMCLK, 1-> ACLK

                  .accumulationCycles = 100 //
               };
